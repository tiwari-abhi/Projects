 ...
 * @author Luvesh
 */
public class ManageClothingOrganizationJPanel extends javax.swing.JPanel {
     ...
     */
    public ManageClothingOrganizationJPanel(JPanel userProcessContainer,Enterprise enterprise) {
        initComponents();
    ...
    private void populateCombo(){
        ...
        for (Organization.ClothingType type : Organization.ClothingType.values()){
            if (!(type.getValue().equals(Organization.ClothingType.Admin.getValue())))
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Manage Clothing Enterprise Organizations");
    ...
    private void addJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addJButtonActionPerformed
        ...
        Organization.ClothingType c = (Organization.ClothingType) organizationJComboBox.getSelectedItem();        
        directory.createClothingOrganization(c);
        populateTable();
