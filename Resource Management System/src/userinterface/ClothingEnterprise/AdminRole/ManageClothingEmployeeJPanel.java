 ...
 * @author Luvesh
 */
public class ManageClothingEmployeeJPanel extends javax.swing.JPanel {
     ...
     */
    public ManageClothingEmployeeJPanel(JPanel userProcessContainer,Enterprise enterprise) {
        initComponents();
    ...
    public void populateOrganizationComboBox(){
        ...
        for (Organization o : organizationDir.getOrganizationList()){
            if ( !(o.getName().equals(Organization.ClothingType.Admin.getValue())) &&
                 !(o.getName().equals(Organization.ClothingType.Provider.getValue())) )
    ...
    private void initComponents() {
        ...
        addJButton.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 18)); // NOI18N
        ...
        organizationJComboBox.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 13)); // NOI18N
        ...
        backJButton.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 18)); // NOI18N
        ...
        organizationEmpJComboBox.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 13)); // NOI18N
        ...
        jLabel4.setText("Manage Clothing Enterprise Employee");
    ...
    private void addJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addJButtonActionPerformed
        ...
        if (organization.getEmployeeDirectory().checkIfEmployeeNameIsUnique(name)){
            ...
            JOptionPane.showMessageDialog(null,"Person with same name exists in directory");
            return;
        }
//        if (organization instanceof ClothingProviderOrg){   
//            ClothingProviderOrg org = (ClothingProviderOrg) organization;
//            org.getClothingProviderDirectory().addToProviderDirectory(name);
//        }
