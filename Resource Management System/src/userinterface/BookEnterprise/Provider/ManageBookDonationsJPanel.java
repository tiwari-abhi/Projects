 ...
 */
public class ManageBookDonationsJPanel extends javax.swing.JPanel {
    ...
    public ManageBookDonationsJPanel(JPanel userProcessContainer, UserAccount account, 
    ...
    public void popPledgeTable(){
        ...
        lblTaxBenefit.setText(String.valueOf(totalCost * system.getBtb().getBooktaxBenefitPercentage()));
    }
    ...
    public void populateResourceJTable() {
        ...
        for (Resource r : provider.getResourceDirectory().getResourceList()){
                ...
                totalBooks += r.getTotalExcessUnits();
    ...
    private void initComponents() {
        ...
        spinnerQuantity.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 13)); // NOI18N
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addGroup(layout.createSequentialGroup()
                            ...
                            .addComponent(lblTaxBenefit, javax.swing.GroupLayout.PREFERRED_SIZE, 89, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(12, 12, 12)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void backJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backJButtonActionPerformed
        ...
        BookProviderWorkAreaJPanel bpwajp = (BookProviderWorkAreaJPanel) component;
        bpwajp.populateDonatedResourceTable();
...
//        BookResource resource = new BookResource();
        ...
        totalBookCount = totalBookCount - fetchqty;
...
//        resource.setUnitPrice(selectedResource.getUnitPrice());
    ...
    private void btnSendDonationActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSendDonationActionPerformed
        ...
        if (!tempList.isEmpty()){
            ...
            BookInventoryOrg org =null;
            
            for (Organization o : enterprise.getOrganizationDirectory().getOrganizationList()){
                if (o instanceof BookInventoryOrg){
                    org = (BookInventoryOrg) o;
                }
            }
            ...
            if (org != null){
                for (Resource r : tempList){
                    ...
                    for(Resource res : org.getBookResourceDirectory().getResourceList()){
                        if (r.equals(res)){
                            alreadyPresent=true;
                    ...
                    if (!alreadyPresent){
                        org.getBookResourceDirectory().addResourceToList(r);
            ...
            JOptionPane.showMessageDialog(null,"Books Sent to Book Inventory");
